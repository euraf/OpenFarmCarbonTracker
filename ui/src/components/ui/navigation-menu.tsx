...
const NavigationMenu = <T extends ValidComponent = "ul">(
  ...
  return (
    <NavigationMenuPrimitive.Root
      gutter={6}
      class={cn(
        "group/menu flex w-max flex-1 list-none items-center justify-center data-[orientation=vertical]:flex-col [&>li]:w-full mb-2 gap-2 bg-slate-700 p-2 rounded-sm",
        local.class
      )}
      {...others}
    >
