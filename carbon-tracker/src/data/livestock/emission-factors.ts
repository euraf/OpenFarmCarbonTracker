export const DEFAULT_PIG_EMISSION_FACTORS = {
  farrowing: 0.8,       // kg CO2e per animal produced during their stage (0-3 weeks)
  nursery: 1.2,         // kg CO2e per animal produced during their stage (3-9 weeks)
  finishers: 2.5,       // kg CO2e per animal produced during their stage (9-28 weeks)
  sows: 4.2,            // kg CO2e per animal yearly
  boars: 3.8            // kg CO2e per animal yearly
};
